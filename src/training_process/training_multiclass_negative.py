...
df_hfb_unknown = df_data[df_data["target"] == "HFB"]
df_hfb_unknown["target"] = 0
...
df_negative = df_data[df_data["target"] == "Negative"]
df_negative["target"] = 3

df_cps = df_data[df_data["target"] == "CPs"]
df_cps["target"] = 4

df_data = pd.concat([df_hfb_unknown, df_hfb_1, df_hfb_2, df_negative, df_cps], axis=0)
